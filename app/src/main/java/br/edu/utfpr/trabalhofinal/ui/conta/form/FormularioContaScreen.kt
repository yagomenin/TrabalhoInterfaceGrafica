    ...
    Column(
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            FormTextField(
                ...
                onValorAlterado = {valor -> if (valor.all {
                    it.isDigit() || it == '.' })
                                  onValorAlterado(valor)},
                enabled = !processando,
        ...
        Row(verticalAlignment = Alignment.CenterVertically,
            ...
            Checkbox(
                ...
                onCheckedChange = { checked ->
                    isChecked = checked
                    onStatusPagamentoAlterado(if (checked) "true" else "false")
                },
                modifier = Modifier
                    .padding(start = 25.dp)
                    .size(48.dp),
        ...
        Row(verticalAlignment = Alignment.CenterVertically,
            ...
            var selecaoTipo by remember { mutableStateOf("entrada") }
            var tipo: String
            RadioButton(
                selected = selecaoTipo == "Despesas",
                onClick = {
                    selecaoTipo = "Despesas"
                    tipo = "DESPESA"
                    onTipoAlterado(tipo)
                },
                modifier = Modifier.padding(start = 25.dp)
            )
            Text(text = "Despesas", modifier = Modifier.padding(start = 8.dp))


            RadioButton(
                selected = selecaoTipo == "Receitas",
                onClick = {
                    selecaoTipo = "Receitas"
                    tipo = "RECEITA"
                    onTipoAlterado(tipo)
                }
            )
            Text(text = "Receitas", modifier = Modifier.padding(start = 8.dp))
        }
    }
}
@Composable
